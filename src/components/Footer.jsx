    ...
    <footer>
      <nav className="nav">
        ...
        <ul>
          ...
          <li className="nav-list footer-nav-list">
            <a
              ...
              href="https://www.linkedin.com/in/travis-shanhun-4340b62a1/"
            >
              <span className="icon">
                <FontAwesomeIcon
                  className="icon-size icon"
          ...
          <li className="nav-list footer-nav-list">
            <a
              className="footer-nav"
              href="https://www.instagram.com/shanhun.codes/"
            >
              <span className="icon">
                <FontAwesomeIcon
                  className="icon-size icon"
        ...
        <div className="designs">
          <p>
            <span className="copy">&copy;</span>2024 All Rights Reserved
          </p>
        </div>
      </nav>
    </footer>
